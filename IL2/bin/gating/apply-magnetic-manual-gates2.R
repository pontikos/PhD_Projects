...
lines(ellipse::ellipse(e.memory.conv$Sigma,centre=e.memory.conv$Mu),col='black',lwd=2)
lines(ellipse::ellipse(e.memory.tregs$Sigma,centre=e.memory.tregs$Mu),col='red',lwd=2)
title(nextElem(figure.labels), adj=0)
